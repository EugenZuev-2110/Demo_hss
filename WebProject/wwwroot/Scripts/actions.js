$(document).ready(function () {
    ...
    $(function () { $('.logos, .xn-logo').mixItUp(); });

    setTimeout(
        function () {
            $('.logos, .xn-logo').mixItUp('sort', 'random');
        }, 500
    )
    setTimeout(
        function () {
    ...
    setTimeout(
        function () {
            $('.logos').mixItUp('sort', 'random').css('top', '35%');
        }, 3000
    );
    ...
    //    $("#").attr("href", $(this).data("theme"));
    //});



    $('.sender textarea').autogrow({ vertical: true, horizontal: false });

    $(".ei-clip").click(function () { $("#upload-file").click(); });
...
function page_content_onresize() {
    ...
    if (typeof onResizeSticky === "function") {
        setTimeout(function () { onResizeSticky(); }, 200);
        //onResizeSticky();
    }
}
...
function x_navigation_minimize(action) {
    ...
    if (action == 'open') {
        $(".page-container").removeClass("page-container-wide");
        $(".page-sidebar .x-navigation").removeClass("x-navigation-minimized");
        $(".x-navigation-minimize").find(".ei").removeClass("ei-indent").addClass("ei-dedent");
    ...
    if (action == 'close') {
        ...
        $(".x-navigation-minimize").find(".ei").removeClass("ei-dedent").addClass("ei-indent");
...
function x_navigation() {
    ...
    $(".add-to-favorite").click(function () {
        $(this).toggleClass("ei-line-star ei-fill-star");
    });
