(function ($) {
    ...
    Selectpicker.prototype = {
        ...
        render: function (updateLi) {
            ...
            //if (this.$newElement.closest("#select-user").length) {
            //    return;
            //}
            ...
            if (!this.$newElement.closest("#select-user").length || itemValue === "-1") {
        ...
        clickListener: function () {
            ...
            this.$menu.on('click', 'li a', function (e) {
                ...
                if (!that.isDisabled() && !$(this).parent().hasClass('disabled')) {
                    ...
                    if ((prevValue != that.$element.val() && that.multiple) || (prevIndex != that.$element.prop('selectedIndex') && !that.multiple) || that.$element.closest("#select-user").length) {
                        that.$element.change();
                    }
                }
            });
